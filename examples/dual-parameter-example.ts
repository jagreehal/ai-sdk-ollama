...
async function main() {
  ...
  console.log('These parameters work with any AI SDK provider (OpenAI, Anthropic, etc.)\n');
  ...
  console.log('These options are Ollama-specific and provide advanced control\n');
  ...
  console.log('Any future Ollama parameters will work without provider updates!\n');
  ...
  console.log('2. Use Ollama options for advanced features and Ollama-specific control');
  console.log('3. Combine both for maximum flexibility (Ollama options take precedence)');
  console.log('4. Future Ollama parameters work automatically without provider updates');
}
